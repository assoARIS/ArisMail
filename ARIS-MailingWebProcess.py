...
port = 587
#
mailSubject = "ARIS - Sortie à Dourdan du 13 octobre 2022"
mailMessage = ""
textMessage = ""
htmlMessage = ""
#
''' fichiers '''
fchXLS = "ARIS - MailingList - 20220309.xlsx"
feuilXLS = "TestPerso"
feuilLOG = "log"
feuilERR = "err"
fchTXT = "ARIS - MailingText - 20220309.txt"
fchHTML = "ARIS - MailingWeb - 20220309.html"
fchPDF = ""
fchPNG = ""
fchJPEG = "Sortie Dourdan - Bulletin Inscription - 20220309.jpeg"
#
       ...
       while(workSheet["C"+str(i)].value != None):
           ...
           and (workSheet["D"+str(i)].value == "R"
               ...
               try:
                   ...
                   mailText = "\n\ncher(e) " +prenom +",\n\n"
                   mailText += textMessage
                   mailHeader.attach(MIMEText(mailText,"plain"))
                   mailHtml = htmlMessage
                   mailHeader.attach(MIMEText(mailHtml,"html"))
                   #
                   ''' attach document
                   global pdfDoc
                   mailHeader.attach(pdfDoc) '''
                   ''' convert mailHeader to string '''
                   global mailContent
...
def main():
    ...
    if(chk == True):
        global textMessage
        textMessage = readTextFile()
    if(chk == True):
        global htmlMessage
        htmlMessage = readHtmlFile()
    '''
    if(chk == True):
        joinDocument()
    '''
